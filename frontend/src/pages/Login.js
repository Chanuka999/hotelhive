...
function Login() {
  ...
  return (
    <section className="container-pad py-10">
      {token ? (
        <div className="mx-auto max-w-lg panel p-6 text-center md:p-8">
          <h1 className="font-display text-4xl">Already Signed In</h1>
          <p className="mt-3 text-sm text-brand-ink/75 dark:text-slate-300">
            You are already logged in. Continue to your dashboard or logout
